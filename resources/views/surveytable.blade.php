...
<!-- <button class="note-icon-pencil" ></button> -->
                                                <a class="btn btn-warning note-icon-pencil" onclick="SurveyDetail('{{ $surveys->id }}')" ></a>
                                                <!-- <button class="note-icon-pencil" ></button> -->
                                                <button class="btn btn-danger note-icon-trash" onclick="surveyDestroy('{{ $surveys->id }}'); return false"></button>
                                            </td>
